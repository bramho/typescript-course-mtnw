...
for (var _i = 0, teamArray_1 = teamArray; _i < teamArray_1.length; _i++) {
    var teamlid_1 = teamArray_1[_i];
    document.write(teamlid_1 + "<br />");
}
// 9.    Maak 6 instance variables van de Teamleden interface en zet hierin de voornaam, achternaam en leeftijd
var teamlid_kim = { voornaam: "Kim", achternaam: "Bilstra", leeftijd: 25 };
var teamlid_niels = { voornaam: "Niels", achternaam: "Ettema", leeftijd: 21 };
var teamlid_koen = { voornaam: "Koen", achternaam: "Van Der Baan", leeftijd: 23 };
var teamlid_coen = { voornaam: "Coen", achternaam: "Slot", leeftijd: 22 };
var teamlid_karen = { voornaam: "Karen", achternaam: "Wiersma", leeftijd: 21 };
var teamlid_bram = { voornaam: "Bram", achternaam: "Honingh", leeftijd: 20 };
...
var Persoon = (function () {
    function Persoon(voornaam, achternaam, leeftijd, isTeamlid) {
        this.voornaam = voornaam;
        this.achternaam = achternaam;
        this.leeftijd = leeftijd;
        this.isTeamlid = isTeamlid;
    }
    Persoon.prototype.toPage = function () {
        document.write(this.voornaam + " " + this.achternaam + " " + this.leeftijd + " " + this.isTeamlid + "<br />");
    };
    Persoon.prototype.checkIfTeamlid = function () {
        if (this.isTeamlid) {
...
var Programmeur = (function (_super) {
    __extends(Programmeur, _super);
    function Programmeur(voornaam, achternaam, leeftijd, isTeamlid) {
        _super.call(this, voornaam, achternaam, leeftijd, isTeamlid); // Antwoord voor vraag 17
    }
    return Programmeur;
}(Persoon));
